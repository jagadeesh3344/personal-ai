...
/**
 * Deterministically evaluates data quality based on available telemetry.
 */
...
/**
 * Deterministically evaluates overall progress status taking into account user's goal.
 */
export function deriveOverallProgressStatus(
  ...
  // GENERAL FITNESS / MAINTAIN / ENDURANCE
...
/**
 * Builds chronological timeline of real recorded milestones and events.
 */
...
/**
 * Master progress snapshot aggregator.
 */
