...
export function analyzeNutritionAdherence(
  ...
  // Filter for days that were actually tracked (at least 1 meal or calories > 0)
  ...
  // Calculate averages ONLY across days that were actually tracked
  ...
  // Caloric & Protein Adherence % against target
