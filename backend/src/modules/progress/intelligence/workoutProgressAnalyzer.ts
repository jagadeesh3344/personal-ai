...
} from '../../workouts/adaptive/progressionEngine.js';
import { aggregateExerciseSessions } from '../../workouts/adaptive/performanceAnalyzer.js';
import { ExerciseHistoryItem } from '../../workouts/adaptive/types.js';
...
export function analyzeWorkoutProgress(
  ...
  // Group history items by exerciseId
  ...
  for (const [exerciseId, items] of exerciseMap.entries()) {
    ...
    // Use adaptive workout engine to classify sessions
